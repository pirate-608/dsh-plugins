...
```powershell
py -3.13 tests\mcp__solidworks__solidworks_add_component_regression.py --output-dir C:\CADAutomationWorkbench\mcp__solidworks__solidworks_add_component_regression
```
...
```powershell
py -3.13 tests\mcp__solidworks__solidworks_sketch_selection_regression.py --output-dir C:\CADAutomationWorkbench\mcp__solidworks__solidworks_skill_regression
```
...
```powershell
py -3.13 tests\mcp__solidworks__solidworks_loadfile4_import_regression.py --output-dir C:\CADAutomationWorkbench\mcp__solidworks__solidworks_loadfile4_import_regression
```
...
```powershell
python tests\mcp__solidworks__solidworks_appearance_regression.py
```
