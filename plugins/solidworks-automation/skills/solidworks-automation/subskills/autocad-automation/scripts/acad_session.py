...
class AutoCADSession:
    ...
    def export_dxf(self, path: str | Path, selection_set_name: str = "DSH_EMPTY_EXPORT_SET") -> Path:
    ...
    def export_bmp_preview(self, path: str | Path, selection_set_name: str = "DSH_PREVIEW_SET") -> Path:
